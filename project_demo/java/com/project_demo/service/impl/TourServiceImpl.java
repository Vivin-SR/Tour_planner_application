...
public class TourServiceImpl implements TourService {
	...
	public boolean updateuser(Long id,Tour tour) {
		...
		userExists.setPassword(tour.getPassword());
	...
	@Override
	public boolean AddUser(Tour tour) {
		Optional<Tour> isExists = tourRepository.findByEmail(tour.getEmail());
	...
	@Override
	public boolean GetUser(Tour tour) {
		Optional<Tour> isExists=tourRepository.existsByName(tour.getName());
		if(isExists.isPresent()) {
			return true;
		}
		else {
